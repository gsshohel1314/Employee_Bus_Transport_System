                          ...
                          <tbody>
                            ...
                            @foreach ($allPick as $value)
                              <tr>
                                  ...
                                  <td>
                                    <a class="approve btn-success" data-approve="{{ url('admin/requestBus/approve/'.$value->id) }}" data-toggle="modal" data-target="#exampleModalApprove">@if($value->is_approved==true) <i class="fa fa-close fa-lg"></i> @else <i class="fa fa-check fa-lg"></i> @endif</a>

                                    &nbsp;

                                    <a href="{{url('admin/requestBus/assign/'.$value->id)}}"><i class="fa fa-check-square fa-lg"> </i></a>

                                    &nbsp;

                                    <a href="{{url('admin/requestBus/'.$value->id)}}"><i class="fa fa-plus-square fa-lg"></i></a>

                                    &nbsp;
                                    {{-- <a href=""><i class="fa fa-pencil-square fa-lg"></i></a> --}}
                                    <a class="busrequestdelete" data-url="{{url('admin/requestBus/'.$value->id)}}" href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-trash fa-lg"></i></a>
                                  </td>
                              </tr>
                            @endforeach
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="" method="post" id="busrequestdelete">
        @csrf
        @method('delete')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="" method="post" id="approve">
        ...
        @method('put')
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"> <p class="text-danger">Bus Request</p></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
