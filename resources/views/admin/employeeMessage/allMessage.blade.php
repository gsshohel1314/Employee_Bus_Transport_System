...
@component('admin.dashboard.bredcumb')
  @slot('title')
    All Message
  @endslot
  <li><a href="{{url('admin/employeeMessage')}}">All</a></li>
@endcomponent
  ...
  <div class="col-md-12">
      <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <div class="row">
              <div class="col-md-8">
                <h3 class="panel-title"><i class="fa fa-cubes"></i> All Employee Message</h3>
              </div>
                          ...
                          <tbody>
                            ...
                            @foreach ($data as $value)
                              <tr>
                                  ...
                                  <td>
                                    <a href="{{url('admin/employeeMessage/'.$value->id)}}"><i class="fa fa-plus-square fa-lg"></i></a>
