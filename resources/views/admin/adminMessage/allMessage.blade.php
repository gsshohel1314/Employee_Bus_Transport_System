...
@component('admin.dashboard.bredcumb')
  @slot('title')
    All Message
  @endslot
  <li><a href="{{url('admin/allAdminMessage')}}">All</a></li>
@endcomponent
  ...
  <div class="col-md-12">
      <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <div class="row">
              <div class="col-md-8">
                <h3 class="panel-title"><i class="fa fa-cubes"></i> All Employee Message For Admin</h3>
              </div>
                          ...
                          <tbody>
                            ...
                            @foreach ($data as $value)
                              <tr>
                                  ...
                                  <td>{{$value->role}}</td>
                                  <td>{{$value->subject}}</td>
                                  <td>{{str_limit($value->description,30)}}</td>

                                  <td>
                                    <a href="{{url('admin/adminMessage/'.$value->id)}}"><i class="fa fa-plus-square fa-lg"></i></a>

                                    <a class="messagedelete" data-url="{{url('admin/adminMessage/'.$value->id)}}" href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-trash fa-lg"></i></a>
                                  </td>
                              </tr>
                            @endforeach
