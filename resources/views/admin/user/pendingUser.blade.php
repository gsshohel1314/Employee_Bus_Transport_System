                          ...
                          <tbody>
                            ...
                            @foreach ($users as $value)
                              <tr>
                                  ...
                                  <td>
                                    <button class="status" data-status="{{ url('admin/user/status/'.$value->id) }}" data-toggle="modal" data-target="#exampleModalApprove">@if($value->status==true) <i class="fa fa-close fa-lg"></i> @else <i class="fa fa-check-square fa-lg"></i> @endif</button>

                                    <a href="{{url('admin/user/'.$value->id)}}"><i class="fa fa-plus-square fa-lg"></i></a>

                                    <a href="{{url('admin/user/'.$value->id.'/edit')}}"><i class="fa fa-pencil-square fa-lg"></i></a>
